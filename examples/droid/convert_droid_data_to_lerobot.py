...
Usage:
python examples/droid/convert_droid_data_to_lerobot.py --data_dir ./data/droid_raw

If you want to push your dataset to the Hugging Face Hub, you can use the following command:
python examples/droid/convert_droid_data_to_lerobot.py --data_dir ./data/droid_raw --push_to_hub
