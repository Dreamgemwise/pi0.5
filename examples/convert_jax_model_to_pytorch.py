...
Example:
    # pi0_droid
    python examples/convert_jax_model_to_pytorch.py --checkpoint_dir ./models/pi0_droid --output_path ./models/pi0_droid_pytorch

    # pi0_aloha_sim
    python examples/convert_jax_model_to_pytorch.py --checkpoint_dir ./models/pi0_aloha_sim --output_path ./models/pi0_aloha_sim_pytorch

    # pi05_droid
    python examples/convert_jax_model_to_pytorch.py --checkpoint_dir ./models/pi05_droid --output_path ./models/pi05_droid_pytorch
"""
...
def load_jax_model_and_print_keys(checkpoint_dir: str):
    ...
    """
    checkpoint_dir = os.path.expanduser(checkpoint_dir) if not checkpoint_dir.startswith("gs://") else checkpoint_dir
